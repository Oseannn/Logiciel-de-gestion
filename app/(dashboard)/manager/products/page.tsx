...
export default function ProductsPage() {
  ...
  const { data: products, loading, refresh: refreshProducts, mutate } = useDataCache<Product[]>(
    'manager-products',
    fetchProducts
  )
  ...
  const openModal = (product?: Product) => {
    if (product) {
      ...
      setFormData({
        ...
        stock: hasRealVariants ? 0 : (product.product_variants[0]?.stock || 0),
